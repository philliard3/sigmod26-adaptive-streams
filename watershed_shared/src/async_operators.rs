            ...
            let result = match &self.aggregate {
                ...
                AggregationExpression::Builtin { field, op } => match op {
                    ...
                    BuiltinAggregator::Count => {
                        ...
                        unimplemented!("count not yet implemented");
                    }
                    BuiltinAggregator::Min => {
                        ...
                        unimplemented!("min not yet implemented");
                    }
                    BuiltinAggregator::Max => {
                        ...
                        unimplemented!("max not yet implemented");
                    }
                    BuiltinAggregator::Avg => {
                        ...
                        unimplemented!("avg not yet implemented");
                    }
                },
            };
...
impl OnnxInferenceOperator {
    async fn process_tuples_new<'a>(
        ...
        let num_to_output = tuples.len();
        if encountered_failure {
            // This may be able to be more forgiving. we could try to output the ones that succeeded by marking where the first error was and nullifying everything after that
